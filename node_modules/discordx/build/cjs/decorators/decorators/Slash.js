...
function Slash(options) {
    return function (target, key) {
        ...
        (0, index_js_1.SlashNameValidator)(name);
        const applicationCommand = index_js_1.DApplicationCommand.create({
        ...
        index_js_1.MetadataStorage.instance.addApplicationCommandSlash(applicationCommand);
    };
}
exports.Slash = Slash;
